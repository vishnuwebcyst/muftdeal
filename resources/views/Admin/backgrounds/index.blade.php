                ...
                <div class="card  px-2 p-md-5 mx-auto">
                    <div class="row">
                        <div class="col-lg-6 text-center p-2 p-md-0 text-md-end">
                            <h4>Menu Background Setting</h4>
                        </div>
                        <div class="col-lg-6 text-center p-2 p-md-0 text-md-end">
                            <a class="btn btn-primary" href="{{ route('background.create') }}">Add Background</a>
                        </div>
                    </div>
                            ...
                            <div class="item">
                                <div class='postion-relative'>
                                    <div class="image-container">
                                        <img src="{{ asset($background->image) }}" alt="Image" class=" background-image">
                                        <div class="image-text">
                                            <form action="{{ route('background.destroy', ['background' => $background->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('delete')
