            ...
            <div class="card">
                <div class="row p-lg-5 p-3">
                    <div class="d-flex justify-content-end">
                        <a href="https://api.whatsapp.com/send?text=https://muftdeal.com/{{ base64_encode($data->id) }}"
                            class="btn btn-primary mx-2" target="blank">Share</a>
                        <button class="btn btn-primary float-end float-sm-center" type="button" data-bs-toggle="modal"
                        ...
                        <div class="menu">
                            <div class="">
                                <div class=" px-lg-5  px-sm-0 px-md-2">
                                    <div class=" shadow-lg px-sm-0 px-md-2 py-5">
                                        ...
                                        <div class="table-responsive menu-font pb-5">
                                            <table class="table menu-font">
                                                <thead class="border-bottom">
                                                    <tr>
                                                        <td class="fs-4 fw-bolder">Items</td>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($foodTypes as $foodType)
                                                        ...
                                                        <tr>
                                                            <td colspan="1" class=" ">
                                                                <strong class="text-danger border-bottom fs-2">{{ $foodType->food_type }}</strong>
                                                            </td>
                                                            @foreach (json_decode($foodType->item_type) as $itemType)
                                                                <td  class="mt-4 text-danger fw-bold">{{ $itemType }}</td>
                                                            @endforeach
                                                        </tr>
                                                        @if ($menuGrouped->has($foodType->id))
                                                            @foreach ($menuGrouped[$foodType->id] as $item)
                                                                <tr>
                                                                    <td class="table_width">{{ $item->item_name }}</td>
                                                                ...
                                                                @endif --}}
                                                                    <td >{{ isset($item->small_price) ? $item->small_price . '/-' : '' }}
                                                                    </td>
                                                                    <td >{{ isset($item->medium_price) ? $item->medium_price . '/-' : '' }}
                                                                    </td>
                                                                    <td >{{ isset($item->large_price) ? $item->large_price . '/-' : '' }}
                                                                    </td>
                                                                    <td>{{ $foodType->name }}</td>
                                                                </tr>
                                                            @endforeach
                                    ...
                                    ?>
                                        <div class="pt-5 text-center">
                                            <p class="m-0 menu-font">Contact for advance bookings: {{ $number }}</p>
