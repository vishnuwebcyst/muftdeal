                ...
                <div class="row">
                    <div class="card">
                        <div class="card-header d-flex justify-content-end">
                            <a href="{{ route('item-type.create', ['restaurant_id' => request('restaurant_id')]) }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class='d-flex'><a data-bs-toggle="modal"
                                                    ...
                                                    <form action="{{ route('item-type.destroy', [$restaurant->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
                                                                ...
                                                                <div class="card card-plain">
                                                                    ...
                                                                    <div class="card-body pb-3">
                                                                        ...
                                                                        <form role="form text-left"
                                                                            action="{{ route('item-type.update', ['item_type' => $restaurant->id]) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('PUT')
